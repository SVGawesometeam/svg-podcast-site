  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand-cta {
      ...
      background: #e00; border-radius: 10px; text-align: center;
    }
    .brand-cta h2 {
      font-size: 1.25rem; font-weight: 800; text-transform: uppercase;
      letter-spacing: -0.005em; line-height: 1.2; margin: 0 0 0.6rem; color: #fff;
    }
    .brand-cta p { font-size: 0.95rem; color: rgba(255,255,255,0.92); margin: 0; }
    .brand-cta a { color: #fff; font-weight: 700; text-decoration: underline; }
